...
const WC2026 = {
  ...
  topScorers: [
    ...
    { name:"Cristiano Ronaldo",country:"POR", flag:"🇵🇹", goals:4, assists:0, note:"Goal vs DR Congo (Jun 17) + brace vs Uzbekistan (Jun 23) + a 68th-minute penalty vs Croatia in the R32 (Jul 2, BMO Field, Toronto) — his first goal at a WC knockout match in six tournament appearances, levelling after Perišić's 53' opener, before Gonçalo Ramos headed a stoppage-time (94') winner as Portugal won 2-1 (VAR also disallowed a late Croatia goal). Extends his own all-time record to 20 career WC goals; Portugal face Spain in the Round of 16 (Jul 6, AT&T Stadium, Arlington)" },
    { name:"Mikel Oyarzabal",  country:"ESP", flag:"🇪🇸", goals:4, assists:0, note:"Brace either side of a Pedro Porro strike (36', 66', 89') sealed Spain's 3-0 R32 win over Austria (SoFi Stadium, Jul 2). Now leads all scorers at World Cup 2026 with 4 goals; Spain reach the Round of 16 to face Portugal" },
  ...
  starMatches: [
    ...
    { home:"POR", away:"ESP", utc:"2026-07-06T19:00", group:"R16", venue:"AT&T Stadium, Arlington TX",
      storyline:"Round of 16 — the Iberian derby. Portugal survived late VAR drama to beat Croatia 2-1 in the R32 (Perišić opener, Ronaldo penalty leveller, Gonçalo Ramos stoppage-time winner, a late Croatia goal ruled out by VAR) — a result that ended Luka Modrić's World Cup career — while Spain cruised past Austria 3-0 behind a Mikel Oyarzabal brace either side of a Pedro Porro strike. Ronaldo (20 career WC goals) vs Lamine Yamal headline a mouth-watering eliminator." }
  ],
  ...
  facts: [
    ...
    { icon:"⭐", title:"Neymar makes his WC 2026 debut as a substitute vs Scotland", category:"Spotlight", detail:"Neymar — Brazil's all-time leading scorer — made his first appearance at the 2026 World Cup, coming on as a 76th