...
const WC2026 = {
  ...
  topScorers: [
    { name:"Kylian Mbappé",    country:"FRA", flag:"🇫🇷", goals:10, assists:4, note:"Brace vs Senegal (Jun 17) + brace vs Iraq (Jun 22) + brace vs Sweden in the Round of 32 (Jun 30) + the winning penalty vs Paraguay in the Round of 16 (Jul 4) + a curling opener in the 2-0 quarter-final win over Morocco (Jul 9) + another brace in the 6-4 third-place defeat to England (Jul 18, 48' & 66'). Now GOLDEN BOOT LEADER on 10 goals, two clear of Messi, and the outright all-time World Cup goalscorer with 22 career goals — passing Messi's 21. One of only four players ever to reach double figures at a single World Cup (after Fontaine, Müller and Kocsis). France finish fourth." },
    { name:"Lionel Messi",     country:"ARG", flag:"🇦🇷", goals:8, assists:4, note:"Hat-trick vs Algeria (Jun 17), brace vs Austria (Jun 22), goal vs Jordan (Jun 28), goal vs Cape Verde (Jul 3) + the 83rd-minute equalizer in the epic 3-2 comeback vs Egypt (Jul 7). Turned provider in the semi-final, laying on both goals in Argentina's 2-1 comeback win over England (Jul 15) . Mbappé's brace in the third-place play-off has pushed the Frenchman two clear (10 goals to 8), so Messi must score twice against Spain in Sunday's final to reclaim the Golden Boot — the pair are level on four assists, which is the tie-break. His 21 career World Cup goals were overtaken by Mbappé's 22 on Jul 18. First player to score in 9 consecutive WC matches. Argentina face Spain in the final (Jul 19, MetLife)." },
    { name:"Jude Bellingham",  country:"ENG", flag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", goals:7, assists:1, note:"Goal vs Croatia (Jun 18 IST) + goal vs Panama (Jun 28 IST) + a quickfire Round of 16 brace vs Mexico at the Azteca (Jul 6 IST, 36' & 38' — the second just 98 seconds after the first, straight from kick-off) + an extra-time brace to beat Norway in the quarter-final (Jul 11, 45+2' & 93') + the 10th and final goal of the 6-4 third-place win over France (Jul 18, 90+8'). His seven goals are the most ever scored by an England player at a single World Cup." },
    { name:"Erling Haaland",   country:"NOR", flag:"🇳🇴", goals:7, assists:0, note:"Brace vs Iraq (Jun 17 IST) + brace vs Senegal (Jun 23 IST) + Round of 32 winner vs Ivory Coast (Jun 30 IST) + late brace vs Brazil in the Round of 16 (Jul 5, 79' & 87') that dumped out the five-time champions. Norway's first-ever World Cup quarter-final ended in a 2-1 extra-time defeat to England (Jul 11), leaving Haaland on seven goals — three behind Golden Boot leader Mbappé." },
    { name:"Harry Kane",       country:"ENG", flag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", goals:6, assists:0, note:"Penalty + header vs Croatia (Jun 18 IST) + goal vs Panama (Jun 28 IST) + Round of 32 brace vs DR Congo (Jul 1 IST) + the 60th-minute penalty in the 3-2 Round of 16 win over Mexico at the Azteca (Jul 6 IST). England's all-time leading World Cup scorer, who went past Gary Lineker this tournament, finishes on six as the Three Lions take bronze — their best World Cup finish since 1966." },
    { name:"Ousmane Dembélé",  country:"FRA", flag:"🇫🇷", goals:6, assists:0, note:"Reached five tournament goals with the clinching strike in France's 2-0 quarter-final win over Morocco (Jul 9, 66'), teed up by Mbappé, then came off the bench to make it 6-4 in the 96th minute of the third-place play-off against England (Jul 18), briefly giving France hope of an astonishing comeback. France finish fourth." },
    ...
    { name:"Bukayo Saka",      country:"ENG", flag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", goals:3, assists:3, note:"Goalless through England's first six matches — and an unused substitute in the semi-final defeat to Argentina — before exploding with a hat-trick in the 6-4 third-place win over France (Jul 18): two inside the first half (37', 45+1') and a penalty three minutes from time (87') after Djed Spence was fouled by Malo Gusto. His second goal was the 300th of the tournament." },
  ...
  facts: [
    ...
    { icon:"🔥", title:"France 4-6 England: most goals in a World Cup match since 1982, and the highest-scoring third-place game ever", category:"Records", detail:"The 2026 bronze-medal match in Miami produced ten goals — the most in any World Cup fixture since Hungary beat El Salvador 10-1 in 1982, and comfortably the most ever in a third-place play-off. England led 4-0 at half-time through Declan Rice (3'), Ezri Konsa (18') and a Bukayo Saka double (37', 45+1'), only for France to reply with three in eighteen second-half minutes via Kylian Mbappé (48', 66') and Bradley Barcola (54'). Saka's 87th-minute penalty completed his hat-trick, Ousmane Dembélé struck at 90+6' and Jude Bellingham had the last word at 90+8'. England's third place is their best World Cup finish since winning the trophy in 1966." },
    { icon:"🐐", title:"Mbappé becomes the World Cup's all-time leading goalscorer with 22", category:"Records", detail:"Kylian Mbappé's double in the third-place play-off against England (Jul 18) took him to 22 career World Cup goals, overtaking Lionel Messi's 21 to become the tournament's outright all-time top scorer. Both men had already passed Miroslav Klose's long-standing record of 16 during this World Cup. Mbappé's ten goals in 2026 also make him only the fourth player in history to reach double figures at a single tournament, after Just Fontaine (13 in 1958), Sándor Kocsis (11 in 1954) and Gerd Müller (10 in 1970)." },
